...
<h2 className='opacity-60 right-8 '>Country:</h2>
 ...
 University of Algiers 2 - Abou EL Kacem Saâdallah -</p>
              ...
              <span className="after:w-1 after:h-[200px] relative after:absolute after:-mt-2 after:bg-teal-600 after:left-6"></span>
               ...
               <p className='mt-10 ml-12  '>Through many videos on the YouTube platform, I got to know Nextjs and  Typescript a bit, which allowed me to build small apps. It did not look particularly nice, but it worked. However, I am always ready to learn something new to develop apps because we use them every day, and I am fascinated by the interaction between the app and the user.
              ...
              <span className="after:w-1 after:h-[200px] relative after:absolute after:-mt-2 after:bg-teal-600 after:left-6"></span>
               ...
               I got to know React and Laravel through many videos on YouTube and their website, which allowed me to build small apps. However, I am always ready to learn something new to develop apps because we use them every day, and I am fascinated by the interaction between the app and the user.</p>
